...
Next, we have to connect the .ned file to the actual source code. In the example below, we have a private variable called `recog_resSignal`with type `simsignal_t`.
![](https://i.imgur.com/bDiyN6B.png)
In the initialize function, we need to register the signal we decided with the `registerSignal` function.
...
![](https://i.imgur.com/KqUxxN5.png)
![](https://i.imgur.com/HPWQ6x5.png)
![](https://i.imgur.com/zhcVflO.png)